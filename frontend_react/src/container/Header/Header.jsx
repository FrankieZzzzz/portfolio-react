        ...
        >
          <div className='app_project-title'>
            ...
            <div className='header-content app__flex'>
              ...
              <p>Hello! My name is Frankie and I'm a dedicated <span>UX Designer</span> and <span>Front-End Developer</span> with a profound passion for the design industry. I pride myself on being a <span>problem solver</span> and <span>creative executor</span>, skills seamlessly demonstrated throughout my graphic design experience. Two years of immersive learning have not only honed my abilities but also opened doors to diverse career possibilities. My passion for technology and continuous <span>software learning</span> drives me to stay abreast of technological advancements, enhancing my problem-solving prowess. As an individual, I thrive on challenges, and as a designer, I am poised to integrate my artistic foundation with advanced skills. I am committed to contributing to innovative solutions and creating impactful <span>user experiences.</span></p>
            </div>
          </div>
        </motion.div>
        {/* textcontent */}
